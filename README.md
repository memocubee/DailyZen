...
> **全螢幕、繁體中文、點擊即換、每天自動更新**

一個輕量級的每日金句小工具，支援嵌入 Notion、Obsidian、任何支援 iframe 的平台。

## ✨ 特色

- ✅ **繁體中文**：自動將一言 API 的簡體內容轉換為台灣繁體（含用詞習慣）
- ✅ **每天一句**：localStorage 快取保證同一天固定一句，隔天自動更新
- ✅ **點擊換句**：全螢幕點擊隨時換新句，淡入動畫
- ✅ **全螢幕自適應**：完美填滿容器，文字大小自動調整
- ✅ **離線可用**：快取後無網路也能顯示
- ✅ **客製化**：可調整金句類型、配色、字體
